...
import { NotebookPen, ChartNetwork, Heart } from 'lucide-vue-next';
...
<template>
  <AppLayout>
    <div class="p-16 min-h-screen">
      <!-- Page Title -->
      <div class="mb-2">
        <h1 class="text-2xl font-bold text-blue-600 font-poppins">Beranda</h1>
      </div>
      <div class="w-30 h-px bg-gray-400 mb-10"></div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
        ...
        <div
          class="group w-full h-[180px] bg-white rounded-[15px] border border-gray-300 border-opacity-30 p-5 relative
            transition-all duration-300 hover:bg-blue-600 hover:scale-105 hover:shadow-xl cursor-pointer"
        >
          <NotebookPen class="w-8 h-9 mb-3 transition-colors duration-300 group-hover:text-white text-blue-600" />
          <div class="text-lg font-bold mb-1 font-poppins transition-colors duration-300 group-hover:text-white text-gray-800">
            Jumlah Produksi Telur
          </div>
          <div class="text-base font-bold mb-1 font-poppins transition-colors duration-300 group-hover:text-white text-gray-800">
            30
          </div>
        ...
        <div
          class="group w-full h-[180px] bg-white rounded-[15px] border border-gray-300 border-opacity-30 p-5 relative
            transition-all duration-300 hover:bg-blue-600 hover:scale-105 hover:shadow-xl cursor-pointer"
        >
          <ChartNetwork class="w-8 h-9 mb-3 transition-colors duration-300 group-hover:text-white text-blue-600" />
          <div class="text-lg font-bold mb-1 font-poppins transition-colors duration-300 group-hover:text-white text-gray-800">
            Perbandingan Produksi
          </div>
          <div class="text-base font-bold mb-1 font-poppins transition-colors duration-300 text-green-600">
            +15%
          </div>
          <div class="text-base font-bold font-poppins transition-colors duration-300 group-hover:text-gray-800 text-gray-500">
            Dari Kemarin
        ...
        <div
          class="group w-full h-[180px] bg-white rounded-[15px] border border-gray-300 border-opacity-30 p-5 relative
            transition-all duration-300 hover:bg-blue-600 hover:scale-105 hover:shadow-xl cursor-pointer"
        >
          <Heart class="w-7 h-8 mb-3 transition-colors duration-300 group-hover:text-white text-blue-600" />
          <div class="text-lg font-bold mb-1 font-poppins transition-colors duration-300 group-hover:text-white text-gray-800">
            Status Perangkat
          </div>
          <div class="text-base font-bold mb-1 font-poppins transition-colors duration-300 text-green-600">
          ...
          <div class="text-base font-bold font-poppins transition-colors duration-300 group-hover:text-white text-gray-500">
            Saat Ini
          </div>
        </div>
      </div>
